...
5. Run `python se_trends.py` to run the web server locally (at [http://127.0.0.1:5000/](http://127.0.0.1:5000/)). Alternatively use a remote server to run the application (make sure it supports [Flask](http://flask.pocoo.org/) and [SQLite3](http://www.sqlite.org/)).
